    ...
    return (
        <Wrapper>
            ...
            <StaticImage
                ...
                width={2168}
                height={2168}
                css={css `width: 40%; z-index: -1; position: absolute; right: 0; display: ${firstNameVisible
                ? "visible"
                : "none"};`}/>
            ...
            <StaticImage
                ...
                width={1818}
                height={1080}
                css={css `width: 40%; z-index: -1; position: absolute; right: 0; display: ${secondNameVisible
                ? "visible"
                : "none"};`}/>
            ...
            <StaticImage
                ...
                width={1024}
                height={576}
                css={css `width: 40%; z-index: -1; position: absolute; right: 0; display: ${thirdNameVisible
                ? "visible"
                : "none"};`}/>
            ...
            <StaticImage
                ...
                width={1497}
                height={1058}
                css={css `width: 40%; z-index: -1; position: absolute; right: 0; display: ${fourthNameVisible
                ? "visible"
                : "none"};`}/>
            ...
            <StaticImage
                ...
                width={3200}
                height={1800}
                css={css `width: 40%; z-index: -1; position: absolute; right: 0; display: ${fifthNameVisible
                ? "visible"
                : "none"};`}/>
